...
qtCreatorFile = "P_10_Examen_Sumas.ui"  # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def control_tiempo(self):
        ...
        self.txt_tiempo_transcurrid.setText(compuesta)
    ...
    def validar(self):
        val_ingresado_usuario = self.txt_resultado.text()
        ...
        if val_ingresado_usuario != "":
            ...
            self.txt_resultado.setText("") #limpiamos el valor ingresado por el usuario
