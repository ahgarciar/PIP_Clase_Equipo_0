...
qtCreatorFile = "P_5_Control_ImagenesInformacion_V2.ui"  # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.datosPersonaje = {
            0: ["SIN SELECCION", 0, 0, 0, ":/Intro/UAT-Logotipo202.png"],  #CUANDO NO SE SELECCIONA UN PERSONAJE VALIDO
            1:["Broly", 22, 30, 28, ":/Principal/broly.jpg"],
            2:["Vegeta", 27, 60, 40, ":/Principal/vegeta.jpg"]
        }
    ...
    def cambia_valor(self):
        try:
            ...
            ruta = datosPersonales[4] #ruta
            print(ruta)
            self.lb_img.setPixmap(QtGui.QPixmap(ruta))
